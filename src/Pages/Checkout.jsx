            ...
            <div className='px-5 sm:px-20 py-8 sm:py-14 my-8 sm:my-14 space-y-5 sm:space-y-8'>
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-8">
                    <form className='border px-4 py-5 space-y-3 sm:space-y-5 h-fit'>
                        ...
                        <button type='submit' className='block px-4 py-3 bg-[--theme-secondary] font-bold hover:bg-[--theme-secondary-hover] transition-colors text-white w-full'>Place order</button>
                    </form>
